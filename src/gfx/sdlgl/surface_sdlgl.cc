/*
   $Id: surface_sdlgl.cc,v 1.1 2006/09/28 19:13:26 gnurou Exp $
...
namespace gfx
{
    ...
    { 
        ...
        else display_target = ((surface_sdlgl *)target)->vis;
    ...
    {
        const surface_sdlgl & src_sdl = (const surface_sdlgl &) src;
